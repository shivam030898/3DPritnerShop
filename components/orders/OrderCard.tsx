...
import { ORDER_STATUS_SEQUENCE, ORDER_STATUS_LABELS, getOrderStageIndex, getEstimatedDelivery } from "@/lib/orders";
    ...
    >
      <div className="flex min-w-0 items-center gap-4">
        <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-surface-2">
          {product ? (
            <Image src={productImage(product.imageId)} alt="" width={48} height={48} className="h-full w-full object-cover" />
          ) : (
